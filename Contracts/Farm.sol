...
contract FarmProRata is Ownable {
    ...
    address public constant trustedDepositTokenAddress = 0x497070e8b6C55fD283D8B259a6971261E2021C01;
    ...
    IPangolinRouter public uniswapRouterV2;
    ...
    constructor(address[] memory swapPath) public {
        ...
        uniswapRouterV2 = IPangolinRouter(0xE54Ca86531e17Ef3616d22Ca28b0D458b6C89106);
    ...
    function updateAccount(address account, address claimAsToken) private {
        ...
        if (pendingDivsEth > 0) {
            ...
            if (claimAsToken == address(0)) {
                require(Token(uniswapRouterV2.WAVAX()).transfer(account, pendingDivsEth), "Could not transfer WETH!");
            } else {
                require(trustedClaimableTokens[claimAsToken], "cannot claim as this token!");
                
                Token(uniswapRouterV2.WAVAX()).approve(address(uniswapRouterV2), pendingDivsEth);
    ...
    function doSwap() private {
        ...
        uint oldWethBalance = Token(uniswapRouterV2.WAVAX()).balanceOf(address(this));
        ...
        uint newWethBalance = Token(uniswapRouterV2.WAVAX()).balanceOf(address(this));
    ...
    function transferAnyERC20Token(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        ...
        require((_tokenAddr != trustedRewardTokenAddress && _tokenAddr != uniswapRouterV2.WAVAX()) || (now > adminClaimableTime), "Admin cannot Transfer out Reward Tokens or WETH Yet!");
