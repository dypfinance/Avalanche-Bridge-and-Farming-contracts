...
contract Governance is Ownable {
    ...
    constructor() public {
        ...
        hardcodedStakingPools[PoolGroupName.AVAX][0] = StakingPool(0x499c588146443235357e9C630A66D6fe0250caA1);
        hardcodedStakingPools[PoolGroupName.AVAX][1] = StakingPool(0xD8aF0591Be4Fba56e3634C992B7Fe4ff0A90B584);
        hardcodedStakingPools[PoolGroupName.AVAX][2] = StakingPool(0xBEBE1fe1444a50AC6EE95EA25Ba80ADF5aC7322C);
        hardcodedStakingPools[PoolGroupName.AVAX][3] = StakingPool(0x79BE220ab2dFcc2f140b59A97bFe6751ed1579B0);
    }
    ...
    function proposeDisburseOrBurn(PoolGroupName poolGroupName) external noContractsAllowed {
        require(poolGroupName == PoolGroupName.AVAX, "Invalid Pool Group Name!");
        require(Token(TRUSTED_TOKEN_ADDRESS).balanceOf(msg.sender) >= MIN_BALANCE_TO_INIT_PROPOSAL, "Insufficient Governance Token Balance");
        lastIndex = lastIndex.add(1);
